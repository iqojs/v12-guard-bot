...
module.exports = async(oldChannel, newChannel) => {
    ...
    if(oldChannel.name !== newChannel.name){
      ...
      const iqo = new Discord.MessageEmbed().setAuthor(user.user.tag, user.user.avatarURL()).setFooter(oldChannel.guild.name, oldChannel.guild.iconURL()).setColor("BLUE")

  await oldChannel.guild.channels.cache.get(config.Guard.log).send(iqo
