...
module.exports = async(oldGuild, newGuild) => {
    ...
    const iqo = new Discord.MessageEmbed().setAuthor(user.user.tag, user.user.avatarURL()).setFooter(newGuild.name, newGuild.iconURL()).setColor("BLUE")

  await newGuild.channels.cache.get(config.Guard.log).send(iqo
    .addFields({
